...
async function launchCLI(options) {
  let { errorHandler } = await import("./error-handler-WZKLOMNX.js"), { isDevelopment } = await import("./local-EENLQIXY.js"), oclif = await import("./lib-OSXFX3I2.js"), { ShopifyConfig } = await import("./custom-oclif-loader-EM3C323N.js");
...
async function exitIfOldNodeVersion(versions = process.versions) {
  ...
  if (nodeMajorVersion < 18) {
    let { renderError } = await import("./ui-WJJNLUOY.js");
    renderError({
...
async function addInitToArgvWhenRunningCreateCLI(options, argv = process.argv) {
  let { findUpAndReadPackageJson } = await import("./node-package-manager-MOK7USRX.js"), { moduleDirectory } = await import("./path-GB4VIEM6.js"), name = (await findUpAndReadPackageJson(moduleDirectory(options.moduleURL))).content.name.replace("@shopify/create-", "");
...
//# sourceMappingURL=chunk-T6CEI4BV.js.map
