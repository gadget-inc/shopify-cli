...
${outputToken.json(scopes)}
`), password) {
    let session = { token: password, storeFqdn: store }, authMethod = isThemeAccessSession(session) ? "theme_access_token" : "custom_app_token";
...
//# sourceMappingURL=chunk-YB5VSLUB.js.map
