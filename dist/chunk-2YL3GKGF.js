...
import {
  cacheClear
} from "./chunk-N4O3YZ3H.js";
import {
  environmentVariables,
  isTruthy
} from "./chunk-T5UA4AJA.js";
import {
  require_lib
...
async function launchCLI(options) {
  let { errorHandler } = await import("./error-handler-VVHFECHY.js"), { isDevelopment } = await import("./local-IPD3M6QD.js"), oclif = await import("./lib-OSXFX3I2.js"), { ShopifyConfig } = await import("./custom-oclif-loader-G2BGVORE.js");
...
async function exitIfOldNodeVersion(versions = process.versions) {
  ...
  if (nodeMajorVersion < 18) {
    let { renderError } = await import("./ui-AU3TAIVT.js");
    renderError({
...
async function addInitToArgvWhenRunningCreateCLI(options, argv = process.argv) {
  let { findUpAndReadPackageJson } = await import("./node-package-manager-GXXZLMFG.js"), { moduleDirectory } = await import("./path-GB4VIEM6.js"), name = (await findUpAndReadPackageJson(moduleDirectory(options.moduleURL))).content.name.replace("@shopify/create-", "");
...
//# sourceMappingURL=chunk-2YL3GKGF.js.map
