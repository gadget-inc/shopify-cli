...
async function launchCLI(options) {
  let { errorHandler } = await import("./error-handler-EPZ47L3G.js"), { isDevelopment } = await import("./local-2MQPAO2W.js"), oclif = await import("./lib-SGEWXU7Z.js"), { ShopifyConfig } = await import("./custom-oclif-loader-MLBG7SWU.js");
...
async function exitIfOldNodeVersion(versions = process.versions) {
  ...
  if (nodeMajorVersion < 18) {
    let { renderError } = await import("./ui-C2XABC6J.js");
    renderError({
...
async function addInitToArgvWhenRunningCreateCLI(options, argv = process.argv) {
  let { findUpAndReadPackageJson } = await import("./node-package-manager-5XGOGW47.js"), { moduleDirectory } = await import("./path-2K5HIMHZ.js"), name = (await findUpAndReadPackageJson(moduleDirectory(options.moduleURL))).content.name.replace("@shopify/create-", "");
...
//# sourceMappingURL=chunk-VRB5T2W7.js.map
