...
} from "./chunk-MG4XIDFH.js";
import {
  fetch
} from "./chunk-SE4ZIDAV.js";
import {
  CLI_KIT_VERSION
...
(function(ErrorCategory2) {
  ErrorCategory2.ThemeCheck = "THEME_CHECK", ErrorCategory2.Network = "NETWORK", ErrorCategory2.FileSystem = "FILE_SYSTEM", ErrorCategory2.Authentication = "AUTHENTICATION", ErrorCategory2.Validation = "VALIDATION", ErrorCategory2.Permission = "PERMISSION", ErrorCategory2.RateLimit = "RATE_LIMIT", ErrorCategory2.Parsing = "PARSING", ErrorCategory2.Unknown = "UNKNOWN";
...
function recordError(error) {
  ...
  _runtimeAnalyticsStore.errors.push(errorEntry), recordEvent(`error:${category}:${errorEntry.message.substring(0, 50)}`);
}
...
//# sourceMappingURL=chunk-4SY7PV5L.js.map
