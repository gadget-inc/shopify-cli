...
async function launchCLI(options) {
  let { errorHandler } = await import("./error-handler-PLPJQTBU.js"), { isDevelopment } = await import("./local-UGE7NSRW.js"), oclif = await import("./lib-SGEWXU7Z.js"), { ShopifyConfig } = await import("./custom-oclif-loader-HCYOCLH4.js");
...
async function exitIfOldNodeVersion(versions = process.versions) {
  ...
  if (nodeMajorVersion < 18) {
    let { renderError } = await import("./ui-HMXQ7BCT.js");
    renderError({
...
async function addInitToArgvWhenRunningCreateCLI(options, argv = process.argv) {
  let { findUpAndReadPackageJson } = await import("./node-package-manager-7MA3SJKV.js"), { moduleDirectory } = await import("./path-2K5HIMHZ.js"), name = (await findUpAndReadPackageJson(moduleDirectory(options.moduleURL))).content.name.replace("@shopify/create-", "");
...
//# sourceMappingURL=chunk-RR2EQST7.js.map
