...
async function launchCLI(options) {
  let { errorHandler } = await import("./error-handler-53ZQAY72.js"), { isDevelopment } = await import("./local-RTROKNPN.js"), oclif = await import("./lib-OSXFX3I2.js"), { ShopifyConfig } = await import("./custom-oclif-loader-JJOQI6AD.js");
...
async function exitIfOldNodeVersion(versions = process.versions) {
  ...
  if (nodeMajorVersion < 18) {
    let { renderError } = await import("./ui-4QZZZJ4A.js");
    renderError({
...
async function addInitToArgvWhenRunningCreateCLI(options, argv = process.argv) {
  let { findUpAndReadPackageJson } = await import("./node-package-manager-GE5X5VCK.js"), { moduleDirectory } = await import("./path-GB4VIEM6.js"), name = (await findUpAndReadPackageJson(moduleDirectory(options.moduleURL))).content.name.replace("@shopify/create-", "");
...
//# sourceMappingURL=chunk-FFPSF2DB.js.map
